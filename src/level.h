...
#define LEVEL_BLOCK_ISSOLID(b) (!(b == SCREENBLOCK_EMPTY || b == SCREENBLOCK_FAKE || b == SCREENBLOCK_NOWIND))
#define LEVEL_BLOCK_ISSLOPE(b) (b == SCREENBLOCK_SLOPE_TL || b == SCREENBLOCK_SLOPE_TR || b == SCREENBLOCK_SLOPE_BL || b == SCREENBLOCK_SLOPE_BR)
